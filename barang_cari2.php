...
<table width="900" border="0" cellpadding="2" cellspacing="1" class="table-border">
  <tr>
    <td colspan="2"><h1><b>PENCARIAN ASET </b></h1></td>
  </tr>
  <tr>
    <td colspan="2">
  ...
  <tr>
    <td colspan="2"><table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
        ...
        <tr>
          ...
          <td width="176" bgcolor="#F5F5F5"><strong>Kode Label</strong></td>
          <td width="71" bgcolor="#F5F5F5"><strong>Status</strong></td>
          <td width="318" bgcolor="#F5F5F5"><strong>Lokasi</strong></td>
          <td width="283" bgcolor="#F5F5F5"><strong>Nama Barang </strong></td>
          <td><strong>Foto </strong></td>
        </tr>
        <?php
	# MENAMPILKAN DATA ASET BARANG (INVENTARIS BARANG)
	$mySql = "SELECT barang_inventaris.*, barang.nm_barang, barang.foto FROM barang_inventaris 
