...
if(isset($_POST['btnSimpan'])){
	...
	if(trim($cmbDivisi)=="Kosong") {
		$pesanError[] = "Data <b>Divisi Penempatan Baru</b> belum diisi, pilih pada combo !";		
	}
...
<table width="900" cellpadding="3" cellspacing="1" class="table-list">
	...
	<tr>
	  ...
	  <td><strong>:</strong></td>
	  <td><input type="date" name="txtTanggal" value="<?php echo $dataTglMutasi; ?>" /></td>
    </tr>
	<tr>
	...
	<tr>
	  ...
	  <td><b>
	    <select name="cmbLokasi">
          ...
          <?php
		  // Menampilkan data Lokasi dengan filter Nama Divisi yang dipilih
