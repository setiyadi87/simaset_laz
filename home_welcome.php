              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title">Selamat Data Di Sistem Informasi Manajemen Aset LAZ AL AZHAR</h3>
                ...
                <div class="box-body">
                  <p>Sistem Informasi Manajemen Aset (SIM ASET) LAZ AL AZHAR merupakan sistem informasi manajemen pendataan aset (inventaris dan ruang) secara terintegrasi seluruh divisi dalam rangka melaksanakan tertib administrasi pengelolaan dan pendataan barang. Aturan yang kami jadikan acuan dalam perancangan SIM Aset ini, salah satunya adalah Permendagri No. 17 Tahun 2007. Sistem ini dapat digunakan baik di lingkungan Lembaga.</p>
                  <p>Sistem Informasi Aset berfungsi untuk melakukan pencatatan mengenai pengadaan, pengesahan, penggunaan, perawatan, status, serta kondisi aset tersebut. 
                    Aset dapat meliputi inventarisasi tanah, inventarisasi gedung, inventarisasi alat angkutan, inventarisasi jaringan, inventarisasi peralatan seperti alat tulis kantor, inventarisasi ruang/gudang dan barang-barang yang terdapat di dalamnya, inventarisasi lokasi lainnya dan barang-barang yang terdapat di dalamnya.</p>
                  <p>Sistem ini dapat digunakan oleh <b>Biro Sarana Prasarana (BSP), Biro Administrasi Umum (BAU), Bagian Gudang, Bagian Rumah Tangga, Bagian Kendaraan, </b>hingga <b>Seksi Keamanan</b>.<br>
                    Aset-aset yang dimiliki oleh suatu Instansi dapat dipantau tentang<b> keberadaan, nilai, perpindahan dan kondisinya</b>. Sistem Informasi Aset dipersiapkan untuk Kebutuhan Perencanaan dalam Utilisasi Ruang dan sharing Fasilitas antar Divisi atau Pihak tertentu.</p>
