...
<h2>TAMPIL DATA PENGADAAN <a href="?open=Pengadaan-Baru" target="_self"><img style='padding-right:0px !important' src="images/btn_add_data.png"  border="0" /></a></h2>
...
<table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="100" bgcolor="#CCCCCC"><strong>Kwitansi / Nota</strong></td>
