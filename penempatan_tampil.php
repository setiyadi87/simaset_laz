...
<table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="242" bgcolor="#CCCCCC"><strong>Divisi &amp; Lokasi</strong></td>
  ...
  <?php
	# Perintah untuk menampilkan data Transaksi penempatan, dilengkapi informasi Lokasi dan Divisi
	$mySql = "SELECT penempatan.*, divisi.nm_divisi, lokasi.nm_lokasi FROM penempatan 
  ...
  <tr bgcolor="<?php echo $warna; ?>">
    ...
    <td><?php echo $myData['nm_divisi'].", ".$myData['nm_lokasi']; ?></td>
