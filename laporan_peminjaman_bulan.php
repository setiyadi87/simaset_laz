...
<table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="220" bgcolor="#CCCCCC"><strong>Amil/ Peminjam </strong></td>
...
<?php
	// Skrip menampilkan data Transaksi Peminjaman dilengkapi informasi Amil
...
<br />
<a href="cetak/peminjaman_bulan.php?bulan=<?php echo $dataBulan; ?>&tahun=<?php echo $dataTahun; ?>" target="_blank"><img src="images/btn_print2.png"  border="0" title="Cetak ke Format HTML"/></a>
</div>