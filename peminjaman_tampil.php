...
<table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <td width="166" bgcolor="#CCCCCC"><strong>Amil</strong></td>
  ...
  <?php
	// Perintah untuk menampilkan Data Transaksi Peminjaman, dilengkapi informasi Amil, dan filter Bulan/Tahun
