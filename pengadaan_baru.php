...
if(isset($_POST['btnSimpan'])){
	...
	if (count($pesanError)>=1 ){
		...
		$mySql	= "INSERT INTO pengadaan (no_pengadaan, tgl_pengadaan, keterangan, kd_supplier, jenis_pengadaan, kd_petugas, foto) 
					VALUES ('$kodeBaru', '$txtTanggal', '$txtKeterangan', '$cmbSupplier', '$cmbJenis', '$userLogin','$fileName')";
		...
		if($myQry){
			...
			echo "<script>";
			echo "window.open('cetak/pengadaan_cetak.php?noNota=$kodeBaru')";
			echo "</script>";
		}
	}	
}
...
<table width="900" cellspacing="1" class="table-list" style="margin-top:0px;">
	...
	<tr>
	  ...
	  <td width="75%"><input name="txtNomor" value="<?php echo $noTransaksi; ?>" size="23" maxlength="20" /></td></tr>
	<tr>
      <td><strong>Tgl.  Pengadaan </strong></td>
	  <td><strong>:</strong></td>
	  <td><input type="date" name="txtTanggal" value="<?php echo $tglTransaksi; ?>" /></td>
    </tr>
	<tr>
	...
	<tr>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td><input name="btnSimpan" type='submit' id='frm' style="cursor:pointer;" value=" SIMPAN DATA " /></td>
    </tr>
</table>
...
<table class="table-list" width="900" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr bgcolor="<?php echo $warna; ?>">
    ...
    <td align="center" bgcolor="#FFFFCC"><a href="index.php?open=Pengadaan-Baru&Act=Delete&ID=<?php echo $ID; ?>" target="_self">Delete</a></td>
  </tr>
<?php 
}?>
  <tr>
